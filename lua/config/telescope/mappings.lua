...
vim.api.nvim_set_keymap("n", '<Leader>te', "<CMD>luafile " .. string.format("%s/%s", vim.fn.stdpath('config'), "lua/config") .. "/examples.lua<CR>", { desc = "Telescope: meus exemplos", noremap = false, nowait = true })
...
map_tele('<Leader>fge', 'search_only_certain_files', "Telescope: grep por extensão")
...
vim.api.nvim_set_keymap("n", '<Leader>N', "<CMD>luafile " .. string.format("%s/%s", vim.fn.stdpath('config'), "lua/libuv") .. "/new_file_plenary_async.lua<CR>", { desc = "New file", noremap = false, nowait = true })
vim.api.nvim_set_keymap("n", '<Leader>tt', "<CMD>luafile " .. string.format("%s/%s", vim.fn.stdpath('config'), "lua/config/telescope") .. "/my_template.lua<CR>", { desc = "Telescope: template", noremap = false, nowait = true })

vim.api.nvim_set_keymap("n", '<Leader>tl', "<CMD>Telescope yabs tasks<CR>", { desc = "Telescope: task list", noremap = false, nowait = true })
