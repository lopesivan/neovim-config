...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-go", "neotest-jest", "neotest-rust", "vim-test", "neotest-plenary", "neotest-python", "neotest-vim-test" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "nvim-dap-python", "nvim-dap-go", "nvim-dap-ui", "one-small-step-for-vimkind" },
  ...
  ["nvim-lspconfig"] = {
    after = { "mason.nvim", "mason-lspconfig.nvim", "mason-tool-installer.nvim", "vim-illuminate", "null-ls.nvim", "schemastore.nvim", "inlay-hints.nvim", "typescript.nvim", "lua-dev.nvim", "lsp_lines.nvim", "fidget.nvim", "nvim-navic" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textsubjects", "nvim-ts-rainbow", "lualine.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-surround', 'vim-searchindex', 'nvim-treesitter-textsubjects', 'nvim-ts-rainbow', 'nvim-notify', 'indent-blankline.nvim', 'nvim-lspconfig', 'lualine.nvim', 'nvim-ts-context-commentstring', 'nvim-pqf', 'gitsigns.nvim', 'nvim-treesitter', 'dressing.nvim', 'FixCursorHold.nvim', 'nvim-bufferline.lua', 'nvim-treesitter-textobjects', 'marks.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
