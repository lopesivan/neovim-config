...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-rust", "vim-test", "neotest-vim-test", "neotest-plenary", "neotest-jest", "neotest-go", "neotest-python" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-path", "cmp-buffer", "cmp-treesitter", "cmp_luasnip", "cmp-nvim-lsp-signature-help", "LuaSnip", "friendly-snippets", "vim-snippets" },
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "nvim-dap-ui", "nvim-dap-python", "nvim-dap-virtual-text", "nvim-dap-go" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-navic", "mason-tool-installer.nvim", "lua-dev.nvim", "fidget.nvim", "lsp_lines.nvim", "null-ls.nvim", "mason.nvim", "mason-lspconfig.nvim", "vim-illuminate", "schemastore.nvim", "typescript.nvim", "inlay-hints.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textsubjects", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "lualine.nvim" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'dressing.nvim', 'nvim-treesitter-textsubjects', 'nvim-lspconfig', 'nvim-pqf', 'vim-searchindex', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-treesitter', 'vim-surround', 'FixCursorHold.nvim', 'nvim-bufferline.lua', 'nvim-treesitter-textobjects', 'lualine.nvim', 'marks.nvim', 'nvim-notify'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-ts-autotag', 'nvim-treesitter-endwise', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
