...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-python", "neotest-rust", "neotest-plenary", "neotest-go", "neotest-jest", "neotest-vim-test", "vim-test" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-buffer", "cmp-treesitter", "cmp_luasnip", "friendly-snippets", "LuaSnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_lines.nvim", "fidget.nvim", "nvim-navic", "schemastore.nvim", "null-ls.nvim", "mason-lspconfig.nvim", "lua-dev.nvim", "inlay-hints.nvim", "vim-illuminate", "mason-tool-installer.nvim", "typescript.nvim", "mason.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-treesitter-textsubjects", "lualine.nvim" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'vim-surround', 'nvim-lspconfig', 'vim-searchindex', 'nvim-pqf', 'nvim-treesitter-textobjects', 'nvim-bufferline.lua', 'nvim-notify', 'marks.nvim', 'FixCursorHold.nvim', 'indent-blankline.nvim', 'nvim-treesitter-textsubjects', 'nvim-treesitter', 'dressing.nvim', 'lualine.nvim', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
