...
_G.packer_plugins = {
  ...
  ["cmp-copilot"] = {
    loaded = true,
    path = "/home/ivan/.config/nvim-beginner/share/nvim/site/pack/packer/start/cmp-copilot",
  ...
  neotest = {
    after = { "neotest-python", "neotest-plenary", "neotest-jest", "vim-test", "neotest-rust", "neotest-go", "neotest-vim-test" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-python", "nvim-dap-go", "nvim-dap-virtual-text", "one-small-step-for-vimkind", "nvim-dap-ui" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_lines.nvim", "fidget.nvim", "mason.nvim", "mason-lspconfig.nvim", "mason-tool-installer.nvim", "lua-dev.nvim", "nvim-navic", "null-ls.nvim", "schemastore.nvim", "typescript.nvim", "inlay-hints.nvim", "vim-illuminate" },
  ...
  ["nvim-treesitter"] = {
    after = { "lualine.nvim", "nvim-treesitter-textsubjects", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-searchindex', 'marks.nvim', 'nvim-lspconfig', 'lualine.nvim', 'nvim-treesitter-textsubjects', 'indent-blankline.nvim', 'gitsigns.nvim', 'dressing.nvim', 'nvim-treesitter', 'FixCursorHold.nvim', 'nvim-notify', 'vim-surround', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-treesitter-textobjects', 'nvim-bufferline.lua', 'nvim-pqf'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
