...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-plenary", "neotest-jest", "vim-test", "neotest-python", "neotest-go", "neotest-vim-test", "neotest-rust" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "one-small-step-for-vimkind", "nvim-dap-go", "nvim-dap-virtual-text", "nvim-dap-python" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-navic", "mason.nvim", "mason-lspconfig.nvim", "vim-illuminate", "null-ls.nvim", "typescript.nvim", "fidget.nvim", "schemastore.nvim", "mason-tool-installer.nvim", "lsp_lines.nvim", "lua-dev.nvim", "inlay-hints.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textsubjects", "lualine.nvim" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'dressing.nvim', 'vim-searchindex', 'nvim-treesitter-textsubjects', 'indent-blankline.nvim', 'nvim-notify', 'nvim-bufferline.lua', 'FixCursorHold.nvim', 'nvim-lspconfig', 'nvim-treesitter', 'gitsigns.nvim', 'marks.nvim', 'lualine.nvim', 'vim-surround', 'nvim-pqf'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
