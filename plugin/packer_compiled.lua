...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-python", "neotest-go", "neotest-jest", "neotest-vim-test", "neotest-rust", "vim-test", "neotest-plenary" },
  ...
  ["nvim-cmp"] = {
    after = { "friendly-snippets", "vim-snippets", "cmp-cmdline", "cmp-treesitter", "cmp-nvim-lua", "cmp-path", "LuaSnip", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp_luasnip", "cmp-nvim-lsp" },
  ...
  ["nvim-lspconfig"] = {
    after = { "mason.nvim", "mason-lspconfig.nvim", "mason-tool-installer.nvim", "vim-illuminate", "null-ls.nvim", "schemastore.nvim", "typescript.nvim", "inlay-hints.nvim", "nvim-navic", "fidget.nvim", "lsp_lines.nvim", "lua-dev.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "lualine.nvim", "nvim-treesitter-textsubjects", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-ts-autotag', 'nvim-treesitter-endwise', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'FixCursorHold.nvim', 'nvim-ts-rainbow', 'lualine.nvim', 'nvim-pqf', 'vim-surround', 'nvim-notify', 'nvim-treesitter-textsubjects', 'dressing.nvim', 'nvim-bufferline.lua', 'nvim-ts-context-commentstring', 'nvim-lspconfig', 'nvim-treesitter-textobjects', 'marks.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
