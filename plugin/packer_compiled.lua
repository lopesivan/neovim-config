...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-plenary", "neotest-python", "neotest-go", "neotest-jest", "neotest-vim-test", "neotest-rust", "vim-test" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-navic", "inlay-hints.nvim", "lsp_lines.nvim", "fidget.nvim", "null-ls.nvim", "mason.nvim", "mason-lspconfig.nvim", "mason-tool-installer.nvim", "lua-dev.nvim", "vim-illuminate", "schemastore.nvim", "typescript.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "lualine.nvim", "nvim-treesitter-textobjects", "nvim-treesitter-textsubjects" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-surround', 'vim-searchindex', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'indent-blankline.nvim', 'lualine.nvim', 'nvim-lspconfig', 'nvim-pqf', 'nvim-notify', 'gitsigns.nvim', 'nvim-treesitter', 'dressing.nvim', 'marks.nvim', 'nvim-treesitter-textobjects', 'nvim-treesitter-textsubjects', 'nvim-bufferline.lua', 'FixCursorHold.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
