...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp-treesitter", "friendly-snippets", "LuaSnip", "cmp_luasnip" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "one-small-step-for-vimkind", "nvim-dap-virtual-text", "nvim-dap-python", "nvim-dap-go" },
  ...
  ["nvim-lspconfig"] = {
    after = { "mason.nvim", "mason-lspconfig.nvim", "lua-dev.nvim", "null-ls.nvim", "schemastore.nvim", "typescript.nvim", "inlay-hints.nvim", "mason-tool-installer.nvim", "fidget.nvim", "lsp_lines.nvim", "nvim-navic", "vim-illuminate" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textsubjects", "nvim-treesitter-textobjects", "lualine.nvim" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-treesitter-endwise', 'nvim-cmp', 'nvim-ts-autotag'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-treesitter', 'marks.nvim', 'nvim-ts-rainbow', 'vim-surround', 'indent-blankline.nvim', 'vim-searchindex', 'gitsigns.nvim', 'nvim-ts-context-commentstring', 'dressing.nvim', 'nvim-bufferline.lua', 'FixCursorHold.nvim', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'lualine.nvim', 'nvim-notify', 'nvim-pqf'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
