...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-python", "neotest-plenary", "vim-test", "neotest-vim-test", "neotest-go", "neotest-rust", "neotest-jest" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "vim-snippets", "cmp-nvim-lua", "cmp-cmdline", "cmp-treesitter", "LuaSnip", "cmp-nvim-lsp-signature-help", "friendly-snippets", "cmp-path", "cmp-buffer" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-python", "one-small-step-for-vimkind", "nvim-dap-virtual-text", "nvim-dap-go" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_lines.nvim", "mason.nvim", "mason-tool-installer.nvim", "typescript.nvim", "inlay-hints.nvim", "fidget.nvim", "nvim-navic", "mason-lspconfig.nvim", "lua-dev.nvim", "vim-illuminate", "schemastore.nvim", "null-ls.nvim" },
  ...
  ["quick-scope"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ivan/.config/nvim-beginner/share/nvim/site/pack/packer/opt/quick-scope",
  ...
  ["vim-snippets"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/ivan/.config/nvim-beginner/share/nvim/site/pack/packer/opt/vim-snippets",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'vim-surround', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-pqf', 'indent-blankline.nvim', 'gitsigns.nvim', 'FixCursorHold.nvim', 'nvim-bufferline.lua', 'dressing.nvim', 'nvim-treesitter-textsubjects', 'marks.nvim', 'nvim-treesitter', 'nvim-lspconfig', 'nvim-notify', 'lualine.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'targets.vim', 'quick-scope', 'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-treesitter-endwise', 'nvim-autopairs', 'nvim-ts-autotag'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
