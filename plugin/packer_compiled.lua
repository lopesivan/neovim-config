...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "nvim-dap-go", "nvim-dap-virtual-text", "nvim-dap-python", "nvim-dap-ui" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_lines.nvim", "nvim-navic", "mason-lspconfig.nvim", "mason-tool-installer.nvim", "lua-dev.nvim", "vim-illuminate", "schemastore.nvim", "typescript.nvim", "inlay-hints.nvim", "null-ls.nvim", "mason.nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "lualine.nvim", "nvim-treesitter-textsubjects" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'marks.nvim', 'vim-searchindex', 'indent-blankline.nvim', 'nvim-lspconfig', 'nvim-notify', 'gitsigns.nvim', 'dressing.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-treesitter-textobjects', 'lualine.nvim', 'nvim-treesitter', 'nvim-pqf', 'nvim-treesitter-textsubjects', 'nvim-bufferline.lua', 'vim-surround', 'FixCursorHold.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
