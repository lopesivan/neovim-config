...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-python", "neotest-go", "vim-test", "neotest-vim-test", "neotest-plenary", "neotest-jest", "neotest-rust" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "one-small-step-for-vimkind", "nvim-dap-ui", "nvim-dap-python", "nvim-dap-go" },
  ...
  ["nvim-lspconfig"] = {
    after = { "mason.nvim", "typescript.nvim", "lua-dev.nvim", "vim-illuminate", "lsp_lines.nvim", "mason-lspconfig.nvim", "mason-tool-installer.nvim", "null-ls.nvim", "schemastore.nvim", "nvim-navic", "inlay-hints.nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textsubjects", "lualine.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'gitsigns.nvim', 'FixCursorHold.nvim', 'nvim-lspconfig', 'nvim-notify', 'nvim-treesitter-textsubjects', 'lualine.nvim', 'vim-surround', 'nvim-treesitter', 'marks.nvim', 'nvim-ts-context-commentstring', 'vim-searchindex', 'nvim-pqf', 'indent-blankline.nvim', 'nvim-treesitter-textobjects', 'dressing.nvim', 'nvim-bufferline.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
