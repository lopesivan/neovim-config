...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lua", "LuaSnip", "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-buffer", "cmp-treesitter", "cmp_luasnip", "friendly-snippets", "cmp-nvim-lsp" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-python", "one-small-step-for-vimkind", "nvim-dap-go", "nvim-dap-virtual-text" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "vim-illuminate", "schemastore.nvim", "typescript.nvim", "fidget.nvim", "mason-lspconfig.nvim", "inlay-hints.nvim", "null-ls.nvim", "nvim-navic", "lsp_lines.nvim", "mason.nvim", "mason-tool-installer.nvim" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-endwise', 'nvim-autopairs', 'nvim-ts-autotag', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'vim-surround', 'FixCursorHold.nvim', 'nvim-treesitter', 'nvim-pqf', 'nvim-bufferline.lua', 'dressing.nvim', 'nvim-treesitter-textsubjects', 'nvim-notify', 'nvim-lspconfig', 'marks.nvim', 'nvim-treesitter-textobjects', 'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim', 'vim-searchindex'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
