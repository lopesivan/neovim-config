...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "nvim-dap-go", "nvim-dap-virtual-text", "nvim-dap-ui", "nvim-dap-python" },
  ...
  ["nvim-lspconfig"] = {
    after = { "mason.nvim", "mason-lspconfig.nvim", "mason-tool-installer.nvim", "lua-dev.nvim", "null-ls.nvim", "typescript.nvim", "inlay-hints.nvim", "lsp_lines.nvim", "fidget.nvim", "vim-illuminate", "schemastore.nvim", "nvim-navic" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "lualine.nvim", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-treesitter-textsubjects" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-ts-rainbow', 'nvim-treesitter', 'lualine.nvim', 'marks.nvim', 'nvim-treesitter-textobjects', 'nvim-bufferline.lua', 'indent-blankline.nvim', 'nvim-ts-context-commentstring', 'nvim-treesitter-textsubjects', 'gitsigns.nvim', 'vim-surround', 'nvim-notify', 'nvim-lspconfig', 'dressing.nvim', 'FixCursorHold.nvim', 'vim-searchindex', 'nvim-pqf'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
