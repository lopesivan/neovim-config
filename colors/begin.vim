...
" highlight Cursor ctermfg=224 ctermbg=235 guifg=#fcdf07 guibg=#303030
" highlight Cursor guibg=#ffcd07 guifg=#000000
...
" ivan: vim-hardway
highlight Visual guibg=#ffcd07 guifg=#000000
hi WarningMsg guibg=#303030 guifg=#fcdf07
hi ErrorMsg   guibg=#303030 guifg=#ee3b3b
hi ColorColumn ctermbg=1 guibg=DarkRed

hi CursorColumn   guifg=none guibg=#37474f guisp=none
hi CursorLine     guifg=none guibg=#37474f guisp=none
" set cursorcolumn cursorline
hi MatchParen cterm=bold,reverse ctermfg=0 ctermbg=190 gui=bold,reverse guifg=#000000 guibg=#d7ff00
"
" hi TabLine      ctermfg=Black  ctermbg=Green     cterm=bold
" hi TabLineFill  ctermfg=Black  ctermbg=Green     cterm=bold
" hi TabLineSel   ctermfg=White  ctermbg=DarkBlue  cterm=bold
" hi TabLine      ctermfg=Black  ctermbg=Green     cterm=bold
" hi TabLineFill  ctermfg=Black  ctermbg=Green     cterm=bold
" hi TabLineSel   ctermfg=White  ctermbg=DarkBlue  cterm=bold
" Popup que lista funções e métodos
hi Pmenu ctermbg=gray guibg=gray
"hi Pmenu ctermbg=242 guibg=black
hi PmenuSel ctermfg=49 ctermbg=233 gui=bold guifg=#00ffaf guibg=#121212
hi StatusLine  ctermfg=0 ctermbg=190 guifg=#000000 guibg=#d7ff00
